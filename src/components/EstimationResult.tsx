...
import { EstimationResult as EstimationResultType } from "@/types";
          ...
          <div className="flex items-center justify-between p-6">
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Generated on {formatDate(result.createdAt)} • Floor plan: {result.fileName}
              </p>
            </div>
          ...
          <div className="p-6">
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-6">
              ...
              <div className="flex space-x-6">
                <div>
                  <div className="text-sm text-gray-500 dark:text-gray-400 mb-1">Cost per sq.ft</div>
                  <div className="text-xl font-semibold">
                    {formatCurrency(result.totalCost / 2000, result.currency)}
                  </div>
                </div>
                
                <div>
                  <div className="text-sm text-gray-500 dark:text-gray-400 mb-1">Estimated area</div>
                  <div className="text-xl font-semibold">
                    ~2,000 sq.ft
                  </div>
                </div>
            ...
            <div className="flex flex-col md:flex-row gap-6 mb-6">
              ...
              <div className="w-full md:w-1/2 flex flex-col">
                <div className="rounded-lg bg-gray-50 p-5 h-full dark:bg-gray-700/50">
                  <h3 className="text-lg font-medium mb-3">AI Analysis Notes</h3>
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                    The floor plan shows a single-family residence with approximately 2,000 sq.ft. 
                    of living space. The design includes 3 bedrooms, 2 bathrooms, an open concept 
                    kitchen and living area, and an attached garage.
                    
                    <br /><br />
                    
                    Based on the complexity of the design, quality of finishes indicated, and 
                    current material costs, the estimated construction cost is 
                    {formatCurrency(result.totalCost, result.currency)}.
                  </p>
                </div>
              </div>
